...
import WireframeHumans from '../components/WireframeHumans';
            ...
            <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-96 flex flex-col gap-6">
                    {botResult ? (
                        ...
                        <div className="bg-white rounded-3xl shadow-xl border border-slate-200 flex flex-col items-center justify-center text-center overflow-hidden" style={{ minHeight: '440px' }}>
                            {/* Gradient header strip */}
                            <div className="w-full px-6 pt-6 pb-2" style={{ background: 'linear-gradient(160deg,#0f172a 0%,#1e3a5f 100%)' }}>
                                <p className="text-blue-300 text-[10px] font-bold uppercase tracking-widest mb-1">Disease Prediction System</p>
                                <h2 className="text-white font-black text-lg mb-1">Body Scan Ready</h2>
                                <p className="text-blue-200 text-xs pb-4">Add symptoms — our ML model will map them to a condition.</p>
                            </div>

                            {/* Wireframe models */}
                            <div className="flex-1 w-full px-4 pt-2" style={{ background: 'linear-gradient(180deg,#1e3a5f08 0%,#f8fafc 60%)' }}>
                                <WireframeHumans style={{ height: '260px' }} />
                            </div>

                            {/* Bottom hint */}
                            <div className="w-full px-6 py-4 border-t border-slate-100 bg-slate-50">
                                <div className="flex items-start gap-3">
                                    <div className="w-8 h-8 rounded-xl flex-shrink-0 flex items-center justify-center text-base" style={{ background: 'linear-gradient(135deg,#3b82f6,#06b6d4)' }}>🔬</div>
                                    <p className="text-slate-500 text-xs leading-relaxed text-left">
                                        Enter <span className="font-bold text-slate-700">at least 2 symptoms</span> on the left and click <span className="font-bold text-blue-600">Analyze</span> — the AI will highlight affected body areas and suggest a specialist.
                                    </p>
                                </div>
                            </div>
                        </div>
